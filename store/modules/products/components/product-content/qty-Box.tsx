...
const QtyBox = ({
  ...
  return (
    <div className="flex px-0 py-[4px] w-[3.75rem] h-fit items-center justify-evenly object-contain  rounded-[4px] border bg-white">
      <div
      ...
      <div className="w-[6px] h-[17px] object-contain text-[14px] font-bold text-center leading-normal">
        {item.quantity}
      </div>
      <div
